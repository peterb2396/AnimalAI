...
#         Above, I store the subset animal name to set the training dataset
    ...
    def get_train_loader(self, train_transform, drop_last=False):
        ...
        if(self.dataset == 'animalkingdom'):
            train_data = AnimalKingdom(self.path, act_dict, total_length=self.total_length, transform=train_transform, mode='train', animal=self.animal)
    ...
    def get_test_loader(self, test_transform, drop_last=False):
        ...
        act_dict = self.get_act_dict()
        if(self.dataset == 'animalkingdom'):
            test_data = AnimalKingdom(self.path, act_dict, total_length=self.total_length, transform=test_transform, mode='val', animal=self.animal)
        elif(self.dataset == 'charades'):
